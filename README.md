...
**NOTE: first time you execute, exported md files will be created in a default KIM suddirectory called 'mdfile' within your install directory. This can be changed later**. 
